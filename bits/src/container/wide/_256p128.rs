...
pub type _256p128 = (u64x4, u64x2);

impl BitsContainer for _256p128 {
    fn new() -> Self {
        Self::default()
    }
...
#[cfg(test)]
mod tests {
    use crate::container::{BitsContainer, _256p128};

    #[test]
    fn bits_default() {
        let bits = <_256p128>::new();
