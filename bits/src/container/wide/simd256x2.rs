...
pub type Simd256x2 = [u64x4; 2];

impl BitsContainer for Simd256x2 {
    fn new() -> Self {
        Self::default()
    }
...
#[cfg(test)]
mod tests {
    use crate::container::{BitsContainer, Simd256x2};

    #[test]
    fn bits_default() {
        let bits = <Simd256x2>::new();
