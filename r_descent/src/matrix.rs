...
use utils::{arg_sort_big_to_small_2d, minimum_in, rand_perm};

// TODO Ben needs to fix this.
...
//                 let old_data = get_slice_using_selected(&data, &old_row.view()); // Matlab line 136
//                 let new_data = get_slice_using_selected(&data, &new_row.view()); // Matlab line 137
//                 let new_union_data = get_slice_using_selected(&data, &new_row_union.view()); // Matlab line 137
//
